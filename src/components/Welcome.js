        ...
        <Zoom delay={500}>
          <div className='col-sm-10 col-md-6 col-lg-7 foto-text'>
            <h2 className='welcome-text text-center'>
              WELCOME TO THE BEST HAIRDRESSING SALON IN STOCKHOLM
            </h2>
            <h4 className='welcome-second text-center align-top'>
              {' '}
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Facilisi
              massa pretium eu tortor blandit dictum curabitur tellus in.
              Consectetur enim at consectetur aliquam. Purus ornare ultricies
              nunc, mi et leo. Commodo egestas bibendum pulvinar orci magna leo,
              blandit quis Aici.
            </h4>
          </div>
        </Zoom>
